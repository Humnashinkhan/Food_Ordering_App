...
const Contact = () => {
  return (
    <div className="md:h-[500px] md:flex justify-between">
      <div className="md:ml-72 pt-16 ml-10">
        <img 
         alt="img"
      ...
      <form>
      <div className="grid gap-5 md:pt-20 p-5 md:mr-64">
        ...
        <input
          ...
          id=""
           ...
           />
          <input 
          className="bg-[#d97919] text-white rounded-md hover:bg-[#9c5813] w-40 ml-24 md:ml-36 py-2"
          type="submit"
          value="Send Message"
          />
      </div>
